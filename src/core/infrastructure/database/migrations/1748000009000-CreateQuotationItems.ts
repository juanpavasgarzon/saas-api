...
export class CreateQuotationItems1748000009000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."line_item_type_enum" AS ENUM('PRODUCT', 'SERVICE', 'ASSET')`,
    );
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_quotation_items_item"      ON "quotation_items" ("itemType", "itemId")`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`DROP TABLE IF EXISTS "quotation_items"`);
    await queryRunner.query(`DROP TYPE IF EXISTS "public"."line_item_type_enum"`);
