...
export class CreatePayrollEntries1748000007000 implements MigrationInterface {
  name = 'CreatePayrollEntries1748000007000';
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`DROP INDEX "IDX_payroll_tenant_status"`);
    await queryRunner.query(`DROP INDEX "IDX_payroll_employee"`);
    await queryRunner.query(`DROP INDEX "IDX_payroll_tenant"`);
