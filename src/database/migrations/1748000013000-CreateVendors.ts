...
export class CreateVendors1748000013000 implements MigrationInterface {
  name = 'CreateVendors1748000013000';
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`DROP INDEX "IDX_vendors_tenant"`);
