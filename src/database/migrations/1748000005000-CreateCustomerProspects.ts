...
export class CreateCustomerProspects1748000005000 implements MigrationInterface {
  name = 'CreateCustomerProspects1748000005000';
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`DROP INDEX IF EXISTS "IDX_customer_prospects_tenant_status"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "IDX_prospects_tenant"`);
    await queryRunner.query(`DROP TABLE IF EXISTS "customer_prospects"`);
    await queryRunner.query(`DROP TYPE IF EXISTS "public"."customer_prospects_source_enum"`);
    await queryRunner.query(`DROP TYPE IF EXISTS "public"."customer_prospects_status_enum"`);
  }
}
