...
export class CreateAccountingTransactions1748000015000 implements MigrationInterface {
  name = 'CreateAccountingTransactions1748000015000';
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`DROP INDEX IF EXISTS "IDX_accounting_tenant_date"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "IDX_accounting_tenant_type"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "IDX_accounting_tenant"`);
    await queryRunner.query(`DROP TABLE IF EXISTS "accounting_transactions"`);
    await queryRunner.query(`DROP TYPE IF EXISTS "public"."accounting_transactions_type_enum"`);
  }
}
