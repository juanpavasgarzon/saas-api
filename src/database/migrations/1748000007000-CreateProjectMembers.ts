...
export class CreateProjectMembers1748000007000 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`DROP INDEX IF EXISTS "IDX_pm_employee"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "IDX_pm_project"`);
    await queryRunner.query(`DROP INDEX IF EXISTS "IDX_pm_tenant"`);
