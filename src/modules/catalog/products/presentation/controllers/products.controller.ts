...
export class ProductsController {
  ...
  @Post()
  @RequirePermission(Permission.CatalogProductsCreate)
  @ApiOperation({ summary: 'Create product', description: 'Registers a new catalog product.' })
  ...
  @Get()
  @RequirePermission(Permission.CatalogProductsRead)
  @ApiOperation({
    summary: 'List products',
    description: 'Returns catalog products with pagination.',
  })
  ...
  @RequirePermission(Permission.CatalogProductsModify)
  ...
  @Delete(':id')
  @HttpCode(HttpStatus.NO_CONTENT)
  @RequirePermission(Permission.CatalogProductsRemove)
