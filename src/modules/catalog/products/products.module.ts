...
import { PRODUCT_LINE_ITEM_ADAPTER } from '@core/application/tokens/line-item-adapters.tokens';
...
import { ProductLineItemAdapter } from './infrastructure/adapters/product-line-item.adapter';
...
@Module({
  ...
  providers: [
    ...
    { provide: PRODUCT_LINE_ITEM_ADAPTER, useClass: ProductLineItemAdapter },
  ],
  exports: [PRODUCT_REPOSITORY, PRODUCT_LINE_ITEM_ADAPTER],
})
