...
import { ASSET_LINE_ITEM_ADAPTER } from '@core/application/tokens/line-item-adapters.tokens';
...
import { AssetLineItemAdapter } from './infrastructure/adapters/asset-line-item.adapter';
...
@Module({
  ...
  providers: [
    ...
    { provide: ASSET_LINE_ITEM_ADAPTER, useClass: AssetLineItemAdapter },
  ],
  exports: [ASSET_REPOSITORY, ASSET_LINE_ITEM_ADAPTER],
})
