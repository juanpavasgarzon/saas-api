export enum Permission {
  ...
  SalesSalesCreate = 'sales.sales.create',
  SalesSalesRead = 'sales.sales.read',
  SalesSalesModify = 'sales.sales.modify',
  ...
  ProcurementVendorsCreate = 'procurement.vendors.create',
  ProcurementVendorsRead = 'procurement.vendors.read',
  ProcurementVendorsModify = 'procurement.vendors.modify',

  ProcurementPurchaseRequestsCreate = 'procurement.purchase-requests.create',
  ProcurementPurchaseRequestsRead = 'procurement.purchase-requests.read',
  ProcurementPurchaseRequestsApprove = 'procurement.purchase-requests.approve',
  ProcurementPurchaseRequestsRemove = 'procurement.purchase-requests.remove',

  ProcurementPurchaseOrdersRead = 'procurement.purchase-orders.read',
  ProcurementPurchaseOrdersReceive = 'procurement.purchase-orders.receive',
  ProcurementPurchaseOrdersCancel = 'procurement.purchase-orders.cancel',
